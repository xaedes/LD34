...
define(['phaser', 'helper', 'objects/tree_evaluator', 'quests/quest'], 
    ...
    function MasterOfEarth(game, gui, treeEvaluator, tier) {
        ...
        this.size = Helper.lerp(0.5,0.1,this.difficulty);
        this.condition = {
            sum_upper: Math.floor(Helper.lerp(5,0,this.difficulty)),
            sum_lower: Math.floor(Helper.lerp(10,20,this.difficulty))
        };
        this.description = "Grow a tree, with only the lower part of the screen filled with leafs.";
        this.description += "\nYou can have at most " + this.condition.sum_upper + " leaves in the upper part";
        this.description += "\nYou need at least " + this.condition.sum_lower + " leaves in the lower part";
